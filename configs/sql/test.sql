create database pinterest_db_test
	...
	;
GRANT ALL PRIVILEGES ON database pinterest_db_test TO pinterest_user;
...
create table pins_vectors (
    ...
    vec tsvector,
	foreign key(idv) references pins(id) on delete cascade
);
...
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA public TO pinterest_user;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO pinterest_user;
