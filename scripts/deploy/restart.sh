...
sudo cp /home/ubuntu/pinterest-backend/build/bin-ci/api /bin/pinterest/api || { echo "cp error"  ; exit 1; }
sudo cp /home/ubuntu/pinterest-backend/build/bin-ci/chat /bin/pinterest/chat || { echo "cp error"  ; exit 1; }
sudo cp /home/ubuntu/pinterest-backend/build/bin-ci/auth /bin/pinterest/auth || { echo "cp error"  ; exit 1; }
sudo cp /home/ubuntu/pinterest-backend/build/bin-ci/search /bin/pinterest/search || { echo "cp error"  ; exit 1; }
